...
При первом запуске с зашифрованными паролями:
1. Система автоматически распознает незашифрованные пароли в базе данных
2. При успешном входе пользователя его пароль будет автоматически зашифрован и обновлен в базе
3. Процесс миграции прозрачен для пользователей - они могут входить с теми же паролями